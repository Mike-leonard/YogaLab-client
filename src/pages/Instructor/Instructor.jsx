...
const Instructor = () => {
    ...
    return (
        <div className="grid grid-cols-3">
            {
                instructors.map(instructor => <div key={instructor?._id} className="max-w-2xl mx-4 sm:max-w-sm md:max-w-sm lg:max-w-sm xl:max-w-sm sm:mx-auto md:mx-auto lg:mx-auto xl:mx-auto mt-16 bg-white shadow-xl rounded-lg text-gray-900">
